    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[310px] md:max-w-[400px] animate-enter mx-auto">
        ...
        <div className="relative bg-white rounded-[1.5rem] p-5 md:p-8 shadow-[0_10px_40px_rgba(0,0,0,0.08)] flex flex-col text-center">
          ...
          {/* Close Button */}
          <button onClick={() => !isDeleting && setShowDeleteModal(false)} className="absolute top-3 right-3 md:top-4 md:right-4 w-8 h-8 flex items-center justify-center rounded-full text-slate-400 hover:text-slate-600 hover:bg-slate-50 transition-colors">
          ...
          <h3 className="text-lg md:text-xl font-black text-slate-900 mb-1.5 md:mb-2 tracking-tight">Hapus Akun?</h3>
