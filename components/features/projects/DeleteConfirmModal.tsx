    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[310px] md:max-w-[400px] animate-enter mx-auto">
        ...
        <div className="relative bg-white rounded-[1.5rem] p-5 md:p-8 shadow-[0_10px_40px_rgba(0,0,0,0.08)] flex flex-col text-center">
          ...
          <h3 className="text-lg md:text-xl font-black text-slate-900 mb-1.5 md:mb-2 tracking-tight">Pindah ke Trash?</h3>
          <p className="text-xs md:text-sm font-medium text-slate-500 mb-5 md:mb-6 leading-relaxed px-1">
            Item ini akan dipindahkan ke <strong className="text-slate-700">Trash</strong> dan dihapus permanen setelah <strong className="text-slate-700">30 hari</strong>. Kamu bisa memulihkannya kapan saja sebelum itu.
          </p>
          ...
          <div className="flex flex-row gap-2 md:gap-3 w-full">
            ...
            >
              {isDeleting ? <i className="fas fa-circle-notch animate-spin text-white"></i> : <><i className="fas fa-trash-alt text-[10px]"></i> Pindah ke Trash</>}
            </button>
            <button 
